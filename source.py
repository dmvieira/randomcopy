...
class MyFrame(wx.Frame):
    def __init__(self, *args, **kwds):
        ...
        kwds["style"] = wx.MINIMIZE_BOX | wx.CAPTION | wx.CLOSE_BOX | wx.CLIP_CHILDREN
...
if __name__ == "__main__":
    ...
    frame_1.SetIcon(wx.Icon('/usr/share/icons/hicolor/48x48/apps/randomcopy.png',wx.BITMAP_TYPE_PNG))
    frame_1.Show()
    app.MainLoop()
